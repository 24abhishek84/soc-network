...
const BetterMePage = (props) => {
    ...
    const [feedbackSummary, setfeedbackSummary] = useState({ display: 'block' });
    ...
    const { totalfeedbacks, FeedbackRequests, mainreceivedList, compitencyRating, receivedFeedbackList } = props;
    useEffect(() => {
        const {
            changeNavTitle: changeNavBarTitle,
            changeNavMenu: changeNavBarMenu,
        } = props;
    ...
    return (
        <Fragment>
            <div style={feedbackSummary}>
                <Nav fill variant="tabs" defaultActiveKey="received" onSelect={handleNavSelect}>
                    <Nav.Item>
            ...
            <OverlayTrigger
                ...
                <Tooltip className="font-size-14 betterme-tootltip">
                    ...
                    <FloatingButton className="btn-primary" bottom={120}>
                        <FontAwesomeIcon icon={faPlus} />
                    </FloatingButton>
                </Tooltip>
                }
